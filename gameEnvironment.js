...
class Game {
    ...
    ballAppear = () => {
        if (this.timer % 120 === 0) {
            ...
            // let newBallRight = new Ball("Right", randomPosition + 800);
    ...
    blitzAppear = () => {
        if (this.timer % 120 === 0) {
            ...
            // let newBlitzRight = new Blitz("Right", randomPosition + 800);
            // this.blitzArr.push(newBlitzRight);
    ...
    collisionCheckBlitz = () => {
        this.blitzArr.forEach((eachBlitz) => {
            if (eachBlitz.blitzX < this.batterX + this.batterW &&
    ...
    gameLoop = () => {
        ...
        //movement();
        // this.player.movement (); // movieminto del batter!!!
